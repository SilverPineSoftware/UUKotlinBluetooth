...
import com.silverpine.uu.bluetooth.UUBluetooth.shortCodeToUuid
...
object UUBluetoothConstants
{
    ...
    object Services
    {
         ...
         */
        val ALERT_NOTIFICATION_SERVICE_UUID = shortCodeToUuid("1811")
         ...
         */
        val AUTOMATION_IO_UUID = shortCodeToUuid("1815")
         ...
         */
        val BATTERY_SERVICE_UUID = shortCodeToUuid("180F")
         ...
         */
        val BLOOD_PRESSURE_UUID = shortCodeToUuid("1810")
         ...
         */
        val BODY_COMPOSITION_UUID = shortCodeToUuid("181B")
         ...
         */
        val BOND_MANAGEMENT_UUID = shortCodeToUuid("181E")
         ...
         */
        val CONTINUOUS_GLUCOSE_MONITORING_UUID = shortCodeToUuid("181F")
         ...
         */
        val CURRENT_TIME_SERVICE_UUID = shortCodeToUuid("1805")
         ...
         */
        val CYCLING_POWER_UUID = shortCodeToUuid("1818")
         ...
         */
        val CYCLING_SPEED_AND_CADENCE_UUID = shortCodeToUuid("1816")
         ...
         */
        val DEVICE_INFORMATION_UUID = shortCodeToUuid("180A")
         ...
         */
        val ENVIRONMENTAL_SENSING_UUID = shortCodeToUuid("181A")
         ...
         */
        val GENERIC_ACCESS_UUID = shortCodeToUuid("1800")
         ...
         */
        val GENERIC_ATTRIBUTE_UUID = shortCodeToUuid("1801")
         ...
         */
        val GLUCOSE_UUID = shortCodeToUuid("1808")
         ...
         */
        val HEALTH_THERMOMETER_UUID = shortCodeToUuid("1809")
         ...
         */
        val HEART_RATE_UUID = shortCodeToUuid("180D")
         ...
         */
        val HTTP_PROXY_UUID = shortCodeToUuid("1823")
         ...
         */
        val HUMAN_INTERFACE_DEVICE_UUID = shortCodeToUuid("1812")
         ...
         */
        val IMMEDIATE_ALERT_UUID = shortCodeToUuid("1802")
         ...
         */
        val INDOOR_POSITIONING_UUID = shortCodeToUuid("1821")
         ...
         */
        val INTERNET_PROTOCOL_SUPPORT_UUID = shortCodeToUuid("1820")
         ...
         */
        val LINK_LOSS_UUID = shortCodeToUuid("1803")
         ...
         */
        val LOCATION_AND_NAVIGATION_UUID = shortCodeToUuid("1819")
         ...
         */
        val NEXT_DST_CHANGE_SERVICE_UUID = shortCodeToUuid("1807")
         ...
         */
        val OBJECT_TRANSFER_UUID = shortCodeToUuid("1825")
         ...
         */
        val PHONE_ALERT_STATUS_SERVICE_UUID = shortCodeToUuid("180E")
         ...
         */
        val PULSE_OXIMETER_UUID = shortCodeToUuid("1822")
         ...
         */
        val REFERENCE_TIME_UPDATE_SERVICE_UUID = shortCodeToUuid("1806")
         ...
         */
        val RUNNING_SPEED_AND_CADENCE_UUID = shortCodeToUuid("1814")
         ...
         */
        val SCAN_PARAMETERS_UUID = shortCodeToUuid("1813")
         ...
         */
        val TRANSPORT_DISCOVERY_UUID = shortCodeToUuid("1824")
         ...
         */
        val TX_POWER_UUID = shortCodeToUuid("1804")
         ...
         */
        val USER_DATA_UUID = shortCodeToUuid("181C")
         ...
         */
        val WEIGHT_SCALE_UUID = shortCodeToUuid("181D")
    }
    ...
    object Characteristics
    {
         ...
         */
        val AEROBIC_HEART_RATE_LOWER_LIMIT_UUID = shortCodeToUuid("2A7E")
         ...
         */
        val AEROBIC_HEART_RATE_UPPER_LIMIT_UUID = shortCodeToUuid("2A84")
         ...
         */
        val AEROBIC_THRESHOLD_UUID = shortCodeToUuid("2A7F")
         ...
         */
        val AGE_UUID = shortCodeToUuid("2A80")
         ...
         */
        val AGGREGATE_UUID = shortCodeToUuid("2A5A")
         ...
         */
        val ALERT_CATEGORY_ID_UUID = shortCodeToUuid("2A43")
         ...
         */
        val ALERT_CATEGORY_ID_BIT_MASK_UUID = shortCodeToUuid("2A42")
         ...
         */
        val ALERT_LEVEL_UUID = shortCodeToUuid("2A06")
         ...
         */
        val ALERT_NOTIFICATION_CONTROL_POINT_UUID = shortCodeToUuid("2A44")
         ...
         */
        val ALERT_STATUS_UUID = shortCodeToUuid("2A3F")
         ...
         */
        val ALTITUDE_UUID = shortCodeToUuid("2AB3")
         ...
         */
        val ANAEROBIC_HEART_RATE_LOWER_LIMIT_UUID = shortCodeToUuid("2A81")
         ...
         */
        val ANAEROBIC_HEART_RATE_UPPER_LIMIT_UUID = shortCodeToUuid("2A82")
         ...
         */
        val ANAEROBIC_THRESHOLD_UUID = shortCodeToUuid("2A83")
         ...
         */
        val ANALOG_UUID = shortCodeToUuid("2A58")
         ...
         */
        val APPARENT_WIND_DIRECTION_UUID = shortCodeToUuid("2A73")
         ...
         */
        val APPARENT_WIND_SPEED_UUID = shortCodeToUuid("2A72")
         ...
         */
        val APPEARANCE_UUID = shortCodeToUuid("2A01")
         ...
         */
        val BAROMETRIC_PRESSURE_TREND_UUID = shortCodeToUuid("2AA3")
         ...
         */
        val BATTERY_LEVEL_UUID = shortCodeToUuid("2A19")
         ...
         */
        val BLOOD_PRESSURE_FEATURE_UUID = shortCodeToUuid("2A49")
         ...
         */
        val BLOOD_PRESSURE_MEASUREMENT_UUID = shortCodeToUuid("2A35")
         ...
         */
        val BODY_COMPOSITION_FEATURE_UUID = shortCodeToUuid("2A9B")
         ...
         */
        val BODY_COMPOSITION_MEASUREMENT_UUID = shortCodeToUuid("2A9C")
         ...
         */
        val BODY_SENSOR_LOCATION_UUID = shortCodeToUuid("2A38")
         ...
         */
        val BOND_MANAGEMENT_CONTROL_POINT_UUID = shortCodeToUuid("2AA4")
         ...
         */
        val BOND_MANAGEMENT_FEATURE_UUID = shortCodeToUuid("2AA5")
         ...
         */
        val BOOT_KEYBOARD_INPUT_REPORT_UUID = shortCodeToUuid("2A22")
         ...
         */
        val BOOT_KEYBOARD_OUTPUT_REPORT_UUID = shortCodeToUuid("2A32")
         ...
         */
        val BOOT_MOUSE_INPUT_REPORT_UUID = shortCodeToUuid("2A33")
         ...
         */
        val CENTRAL_ADDRESS_RESOLUTION_UUID = shortCodeToUuid("2AA6")
         ...
         */
        val CGM_FEATURE_UUID = shortCodeToUuid("2AA8")
         ...
         */
        val CGM_MEASUREMENT_UUID = shortCodeToUuid("2AA7")
         ...
         */
        val CGM_SESSION_RUN_TIME_UUID = shortCodeToUuid("2AAB")
         ...
         */
        val CGM_SESSION_START_TIME_UUID = shortCodeToUuid("2AAA")
         ...
         */
        val CGM_SPECIFIC_OPS_CONTROL_POINT_UUID = shortCodeToUuid("2AAC")
         ...
         */
        val CGM_STATUS_UUID = shortCodeToUuid("2AA9")
         ...
         */
        val CSC_FEATURE_UUID = shortCodeToUuid("2A5C")
         ...
         */
        val CSC_MEASUREMENT_UUID = shortCodeToUuid("2A5B")
         ...
         */
        val CURRENT_TIME_UUID = shortCodeToUuid("2A2B")
         ...
         */
        val CYCLING_POWER_CONTROL_POINT_UUID = shortCodeToUuid("2A66")
         ...
         */
        val CYCLING_POWER_FEATURE_UUID = shortCodeToUuid("2A65")
         ...
         */
        val CYCLING_POWER_MEASUREMENT_UUID = shortCodeToUuid("2A63")
         ...
         */
        val CYCLING_POWER_VECTOR_UUID = shortCodeToUuid("2A64")
         ...
         */
        val DATABASE_CHANGE_INCREMENT_UUID = shortCodeToUuid("2A99")
         ...
         */
        val DATE_OF_BIRTH_UUID = shortCodeToUuid("2A85")
         ...
         */
        val DATE_OF_THRESHOLD_ASSESSMENT_UUID = shortCodeToUuid("2A86")
         ...
         */
        val DATE_TIME_UUID = shortCodeToUuid("2A08")
         ...
         */
        val DAY_DATE_TIME_UUID = shortCodeToUuid("2A0A")
         ...
         */
        val DAY_OF_WEEK_UUID = shortCodeToUuid("2A09")
         ...
         */
        val DESCRIPTOR_VALUE_CHANGED_UUID = shortCodeToUuid("2A7D")
         ...
         */
        val DEVICE_NAME_UUID = shortCodeToUuid("2A00")
         ...
         */
        val DEW_POINT_UUID = shortCodeToUuid("2A7B")
         ...
         */
        val DIGITAL_UUID = shortCodeToUuid("2A56")
         ...
         */
        val DST_OFFSET_UUID = shortCodeToUuid("2A0D")
         ...
         */
        val ELEVATION_UUID = shortCodeToUuid("2A6C")
         ...
         */
        val EMAIL_ADDRESS_UUID = shortCodeToUuid("2A87")
         ...
         */
        val EXACT_TIME_256_UUID = shortCodeToUuid("2A0C")
         ...
         */
        val FAT_BURN_HEART_RATE_LOWER_LIMIT_UUID = shortCodeToUuid("2A88")
         ...
         */
        val FAT_BURN_HEART_RATE_UPPER_LIMIT_UUID = shortCodeToUuid("2A89")
         ...
         */
        val FIRMWARE_REVISION_STRING_UUID = shortCodeToUuid("2A26")
         ...
         */
        val FIRST_NAME_UUID = shortCodeToUuid("2A8A")
         ...
         */
        val FIVE_ZONE_HEART_RATE_LIMITS_UUID = shortCodeToUuid("2A8B")
         ...
         */
        val FLOOR_NUMBER_UUID = shortCodeToUuid("2AB2")
         ...
         */
        val GENDER_UUID = shortCodeToUuid("2A8C")
         ...
         */
        val GLUCOSE_FEATURE_UUID = shortCodeToUuid("2A51")
         ...
         */
        val GLUCOSE_MEASUREMENT_UUID = shortCodeToUuid("2A18")
         ...
         */
        val GLUCOSE_MEASUREMENT_CONTEXT_UUID = shortCodeToUuid("2A34")
         ...
         */
        val GUST_FACTOR_UUID = shortCodeToUuid("2A74")
         ...
         */
        val HARDWARE_REVISION_STRING_UUID = shortCodeToUuid("2A27")
         ...
         */
        val HEART_RATE_CONTROL_POINT_UUID = shortCodeToUuid("2A39")
         ...
         */
        val HEART_RATE_MAX_UUID = shortCodeToUuid("2A8D")
         ...
         */
        val HEART_RATE_MEASUREMENT_UUID = shortCodeToUuid("2A37")
         ...
         */
        val HEAT_INDEX_UUID = shortCodeToUuid("2A7A")
         ...
         */
        val HEIGHT_UUID = shortCodeToUuid("2A8E")
         ...
         */
        val HID_CONTROL_POINT_UUID = shortCodeToUuid("2A4C")
         ...
         */
        val HID_INFORMATION_UUID = shortCodeToUuid("2A4A")
         ...
         */
        val HIP_CIRCUMFERENCE_UUID = shortCodeToUuid("2A8F")
         ...
         */
        val HTTP_CONTROL_POINT_UUID = shortCodeToUuid("2ABA")
         ...
         */
        val HTTP_ENTITY_BODY_UUID = shortCodeToUuid("2AB9")
         ...
         */
        val HTTP_HEADERS_UUID = shortCodeToUuid("2AB7")
         ...
         */
        val HTTP_STATUS_CODE_UUID = shortCodeToUuid("2AB8")
         ...
         */
        val HTTPS_SECURITY_UUID = shortCodeToUuid("2ABB")
         ...
         */
        val HUMIDITY_UUID = shortCodeToUuid("2A6F")
         ...
         */
        val IEEE_11073_20601_REGULATORY_CERTIFICATION_DATA_LIST_UUID = shortCodeToUuid("2A2A")
         ...
         */
        val INDOOR_POSITIONING_CONFIGURATION_UUID = shortCodeToUuid("2AAD")
         ...
         */
        val INTERMEDIATE_CUFF_PRESSURE_UUID = shortCodeToUuid("2A36")
         ...
         */
        val INTERMEDIATE_TEMPERATURE_UUID = shortCodeToUuid("2A1E")
         ...
         */
        val IRRADIANCE_UUID = shortCodeToUuid("2A77")
         ...
         */
        val LANGUAGE_UUID = shortCodeToUuid("2AA2")
         ...
         */
        val LAST_NAME_UUID = shortCodeToUuid("2A90")
         ...
         */
        val LATITUDE_UUID = shortCodeToUuid("2AAE")
         ...
         */
        val LN_CONTROL_POINT_UUID = shortCodeToUuid("2A6B")
         ...
         */
        val LN_FEATURE_UUID = shortCodeToUuid("2A6A")
         ...
         */
        val LOCAL_EAST_COORDINATE_UUID = shortCodeToUuid("2AB1")
         ...
         */
        val LOCAL_NORTH_COORDINATE_UUID = shortCodeToUuid("2AB0")
         ...
         */
        val LOCAL_TIME_INFORMATION_UUID = shortCodeToUuid("2A0F")
         ...
         */
        val LOCATION_AND_SPEED_UUID = shortCodeToUuid("2A67")
         ...
         */
        val LOCATION_NAME_UUID = shortCodeToUuid("2AB5")
         ...
         */
        val LONGITUDE_UUID = shortCodeToUuid("2AAF")
         ...
         */
        val MAGNETIC_DECLINATION_UUID = shortCodeToUuid("2A2C")
         ...
         */
        val MAGNETIC_FLUX_DENSITY_2D_UUID = shortCodeToUuid("2AA0")
         ...
         */
        val MAGNETIC_FLUX_DENSITY_3D_UUID = shortCodeToUuid("2AA1")
         ...
         */
        val MANUFACTURER_NAME_STRING_UUID = shortCodeToUuid("2A29")
         ...
         */
        val MAXIMUM_RECOMMENDED_HEART_RATE_UUID = shortCodeToUuid("2A91")
         ...
         */
        val MEASUREMENT_INTERVAL_UUID = shortCodeToUuid("2A21")
         ...
         */
        val MODEL_NUMBER_STRING_UUID = shortCodeToUuid("2A24")
         ...
         */
        val NAVIGATION_UUID = shortCodeToUuid("2A68")
         ...
         */
        val NEW_ALERT_UUID = shortCodeToUuid("2A46")
         ...
         */
        val OBJECT_ACTION_CONTROL_POINT_UUID = shortCodeToUuid("2AC5")
         ...
         */
        val OBJECT_CHANGED_UUID = shortCodeToUuid("2AC8")
         ...
         */
        val OBJECT_FIRST_CREATED_UUID = shortCodeToUuid("2AC1")
         ...
         */
        val OBJECT_ID_UUID = shortCodeToUuid("2AC3")
         ...
         */
        val OBJECT_LAST_MODIFIED_UUID = shortCodeToUuid("2AC2")
         ...
         */
        val OBJECT_LIST_CONTROL_POINT_UUID = shortCodeToUuid("2AC6")
         ...
         */
        val OBJECT_LIST_FILTER_UUID = shortCodeToUuid("2AC7")
         ...
         */
        val OBJECT_NAME_UUID = shortCodeToUuid("2ABE")
         ...
         */
        val OBJECT_PROPERTIES_UUID = shortCodeToUuid("2AC4")
         ...
         */
        val OBJECT_SIZE_UUID = shortCodeToUuid("2AC0")
         ...
         */
        val OBJECT_TYPE_UUID = shortCodeToUuid("2ABF")
         ...
         */
        val OTS_FEATURE_UUID = shortCodeToUuid("2ABD")
         ...
         */
        val PERIPHERAL_PREFERRED_CONNECTION_PARAMETERS_UUID = shortCodeToUuid("2A04")
         ...
         */
        val PERIPHERAL_PRIVACY_FLAG_UUID = shortCodeToUuid("2A02")
         ...
         */
        val PLX_CONTINUOUS_MEASUREMENT_UUID = shortCodeToUuid("2A5F")
         ...
         */
        val PLX_FEATURES_UUID = shortCodeToUuid("2A60")
         ...
         */
        val PLX_SPOT_CHECK_MEASUREMENT_UUID = shortCodeToUuid("2A5E")
         ...
         */
        val PNP_ID_UUID = shortCodeToUuid("2A50")
         ...
         */
        val POLLEN_CONCENTRATION_UUID = shortCodeToUuid("2A75")
         ...
         */
        val POSITION_QUALITY_UUID = shortCodeToUuid("2A69")
         ...
         */
        val PRESSURE_UUID = shortCodeToUuid("2A6D")
         ...
         */
        val PROTOCOL_MODE_UUID = shortCodeToUuid("2A4E")
         ...
         */
        val RAINFALL_UUID = shortCodeToUuid("2A78")
         ...
         */
        val RECONNECTION_ADDRESS_UUID = shortCodeToUuid("2A03")
         ...
         */
        val RECORD_ACCESS_CONTROL_POINT_UUID = shortCodeToUuid("2A52")
         ...
         */
        val REFERENCE_TIME_INFORMATION_UUID = shortCodeToUuid("2A14")
         ...
         */
        val REPORT_UUID = shortCodeToUuid("2A4D")
         ...
         */
        val REPORT_MAP_UUID = shortCodeToUuid("2A4B")
         ...
         * AssignedNumber: 2AC9
         */
        val RESOLVABLE_PRIVATE_ADDRESS_ONLY_UUID = shortCodeToUuid("2AC9")
         ...
         */
        val RESTING_HEART_RATE_UUID = shortCodeToUuid("2A92")
         ...
         */
        val RINGER_CONTROL_POINT_UUID = shortCodeToUuid("2A40")
         ...
         */
        val RINGER_SETTING_UUID = shortCodeToUuid("2A41")
         ...
         */
        val RSC_FEATURE_UUID = shortCodeToUuid("2A54")
         ...
         */
        val RSC_MEASUREMENT_UUID = shortCodeToUuid("2A53")
         ...
         */
        val SC_CONTROL_POINT_UUID = shortCodeToUuid("2A55")
         ...
         */
        val SCAN_INTERVAL_WINDOW_UUID = shortCodeToUuid("2A4F")
         ...
         */
        val SCAN_REFRESH_UUID = shortCodeToUuid("2A31")
         ...
         */
        val SENSOR_LOCATION_UUID = shortCodeToUuid("2A5D")
         ...
         */
        val SERIAL_NUMBER_STRING_UUID = shortCodeToUuid("2A25")
         ...
         */
        val SERVICE_CHANGED_UUID = shortCodeToUuid("2A05")
         ...
         */
        val SOFTWARE_REVISION_STRING_UUID = shortCodeToUuid("2A28")
         ...
         */
        val SPORT_TYPE_FOR_AEROBIC_AND_ANAEROBIC_THRESHOLDS_UUID = shortCodeToUuid("2A93")
         ...
         */
        val SUPPORTED_NEW_ALERT_CATEGORY_UUID = shortCodeToUuid("2A47")
         ...
         */
        val SUPPORTED_UNREAD_ALERT_CATEGORY_UUID = shortCodeToUuid("2A48")
         ...
         */
        val SYSTEM_ID_UUID = shortCodeToUuid("2A23")
         ...
         */
        val TDS_CONTROL_POINT_UUID = shortCodeToUuid("2ABC")
         ...
         */
        val TEMPERATURE_UUID = shortCodeToUuid("2A6E")
         ...
         */
        val TEMPERATURE_MEASUREMENT_UUID = shortCodeToUuid("2A1C")
         ...
         */
        val TEMPERATURE_TYPE_UUID = shortCodeToUuid("2A1D")
         ...
         */
        val THREE_ZONE_HEART_RATE_LIMITS_UUID = shortCodeToUuid("2A94")
         ...
         */
        val TIME_ACCURACY_UUID = shortCodeToUuid("2A12")
         ...
         */
        val TIME_SOURCE_UUID = shortCodeToUuid("2A13")
         ...
         */
        val TIME_UPDATE_CONTROL_POINT_UUID = shortCodeToUuid("2A16")
         ...
         */
        val TIME_UPDATE_STATE_UUID = shortCodeToUuid("2A17")
         ...
         */
        val TIME_WITH_DST_UUID = shortCodeToUuid("2A11")
         ...
         */
        val TIME_ZONE_UUID = shortCodeToUuid("2A0E")
         ...
         */
        val TRUE_WIND_DIRECTION_UUID = shortCodeToUuid("2A71")
         ...
         */
        val TRUE_WIND_SPEED_UUID = shortCodeToUuid("2A70")
         ...
         */
        val TWO_ZONE_HEART_RATE_LIMIT_UUID = shortCodeToUuid("2A95")
         ...
         */
        val TX_POWER_LEVEL_UUID = shortCodeToUuid("2A07")
         ...
         */
        val UNCERTAINTY_UUID = shortCodeToUuid("2AB4")
         ...
         */
        val UNREAD_ALERT_STATUS_UUID = shortCodeToUuid("2A45")
         ...
         */
        val URI_UUID = shortCodeToUuid("2AB6")
         ...
         */
        val USER_CONTROL_POINT_UUID = shortCodeToUuid("2A9F")
         ...
         */
        val USER_INDEX_UUID = shortCodeToUuid("2A9A")
         ...
         */
        val UV_INDEX_UUID = shortCodeToUuid("2A76")
         ...
         */
        val VO2_MAX_UUID = shortCodeToUuid("2A96")
         ...
         */
        val WAIST_CIRCUMFERENCE_UUID = shortCodeToUuid("2A97")
         ...
         */
        val WEIGHT_UUID = shortCodeToUuid("2A98")
         ...
         */
        val WEIGHT_MEASUREMENT_UUID = shortCodeToUuid("2A9D")
         ...
         */
        val WEIGHT_SCALE_FEATURE_UUID = shortCodeToUuid("2A9E")
         ...
         */
        val WIND_CHILL_UUID = shortCodeToUuid("2A79")
    }
    ...
    object Descriptors
    {
         ...
         */
        val CHARACTERISTIC_AGGREGATE_FORMAT_UUID = shortCodeToUuid("2905")
         ...
         */
        val CHARACTERISTIC_EXTENDED_PROPERTIES_UUID = shortCodeToUuid("2900")
         ...
         */
        val CHARACTERISTIC_PRESENTATION_FORMAT_UUID = shortCodeToUuid("2904")
         ...
         */
        val CHARACTERISTIC_USER_DESCRIPTION_UUID = shortCodeToUuid("2901")
         ...
         */
        val CLIENT_CHARACTERISTIC_CONFIGURATION_UUID = shortCodeToUuid("2902")
         ...
         */
        val ENVIRONMENTAL_SENSING_CONFIGURATION_UUID = shortCodeToUuid("290B")
         ...
         */
        val ENVIRONMENTAL_SENSING_MEASUREMENT_UUID = shortCodeToUuid("290C")
         ...
         */
        val ENVIRONMENTAL_SENSING_TRIGGER_SETTING_UUID = shortCodeToUuid("290D")
         ...
         */
        val EXTERNAL_REPORT_REFERENCE_UUID = shortCodeToUuid("2907")
         ...
         */
        val NUMBER_OF_DIGITALS_UUID = shortCodeToUuid("2909")
         ...
         */
        val REPORT_REFERENCE_UUID = shortCodeToUuid("2908")
         ...
         */
        val SERVER_CHARACTERISTIC_CONFIGURATION_UUID = shortCodeToUuid("2903")
         ...
         */
        val TIME_TRIGGER_SETTING_UUID = shortCodeToUuid("290E")
         ...
         */
        val VALID_RANGE_UUID = shortCodeToUuid("2906")
         ...
         */
        val VALUE_TRIGGER_SETTING_UUID = shortCodeToUuid("290A")
    }
}